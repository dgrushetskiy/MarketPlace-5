package com.senla.kedaleanid.controller.restcontroller;
...
public abstract class AbstractController {
    ...
    protected <T> List<T> castModelDtoList(List<IModelDto> modelDtoList, Class<T> clazz) {
        List<T> dtos = new ArrayList<>();
        for (IModelDto listElement : modelDtoList) {
